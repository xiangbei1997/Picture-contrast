...
if __name__ == "__main__":
    for i in range(0, 4):
        p1 = r"E:\python_scrapy_code\Captcha-Recognition\picture\womanq.png"
        p2 = r"E:\python_scrapy_code\Captcha-Recognition\picture\woman%s.png" % str(i)
        print(p2)
        runAllImageSimilaryFun(p1, p2)
# ————————————————
# 版权声明：本文为CSDN博主「Waldenz」的原创文章，遵循
# CC
# 4.0
# BY - SA
# 版权协议，转载请附上原文出处链接及本声明。
# 原文链接：https: // blog.csdn.net / enter89 / article / details / 90293971
